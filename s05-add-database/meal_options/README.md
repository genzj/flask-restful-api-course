...
## Development environment and release process
 ...
 - create virtualenv with Flask and meal-options installed into it (latter is installed in
...
install it (`pip install meal_options.tar.gz`), ensure that configuration file exists and
`MEAL_OPTIONS_SETTINGS` environment variable points to it, ensure that user has access to the
